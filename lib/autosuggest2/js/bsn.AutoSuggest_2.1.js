...
_bsn.AutoSuggest = function (id, param)
{
	...
	// defaults	
	//
	var def = {minchars:1, meth:"get", varname:"input", className:"autosuggest", timeout:2500, delay:500, offsety:-5, shownoresults: true, noresults: "No hay registros!", maxheight: 250, cache: true};
	for (k in def)
