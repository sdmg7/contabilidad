...
?>
	...
	<chart_rect x='20' y='20' width='1250' height='430' positive_color='ffffff' positive_alpha='50' />
	<chart_transition type='scale' delay='0.5' duration='1' order='series' />
	<chart_type><?php echo $charttype ?></chart_type>

	<draw>
		<rect bevel='bg' layer='background' x='0' y='0' width='1280' height='480' fill_color='8EBBE9' line_thickness='0' />
	</draw>
	<filter>
