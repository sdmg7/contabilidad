               ...
               var $charttype="3d pie";
                ...
                function __construct($Atitle,$AsHeader,$AsFooter,$Afont='Arial',$AtitleFontSize=20,$aFontColor=0xf,$AbackgroundColor=0x0)
                {
                 ...
                 $this->records=split('[|]',$_GET['data']);
                  ...
                  $this->chart['chart_data'][0] = array (" ","Linea");
...
//                  $this->chart['chart_data'] = array ($this->labels,$this->values);
                 ...
                 $this->chart['pref'] = array ( 'rotation_x'=>60 );
                 $this->chart[ 'chart_rect' ] = array ( 'x'=>100, 'y'=>60, 'width'=>350, 'height'=>300, 'positive_alpha'=>0 );
                 $this->chart[ 'chart_transition' ] = array ( 'type'=>"slide_left", 'delay'=>0, 'duration'=>.1, 'order'=>"category" );
                 ...
                 $this->chart[ 'legend_rect' ] = array ( 'x'=>0, 'y'=>25, 'width'=>50, 'height'=>220, 'margin'=>10, 'fill_color'=>"ffffff", 'fill_alpha'=>10, 'line_color'=>"000000", 'line_alpha'=>1, 'line_thickness'=>1 );
                 $this->chart[ 'legend_transition' ] = array ( 'type'=>"slide_left", 'delay'=>0, 'duration'=>0 );
