               ...
               var $charttype="3d pie";
                ...
                function __construct($Atitle,$AsHeader,$AsFooter,$Afont='Arial',$AtitleFontSize=20,$aFontColor=0xf,$AbackgroundColor=0x0)
                {
                 ...
                 $this->records=split('[|]',$_GET['data']);
                  ...
                  $this->chart['chart_data'][0] = array (" ","Area");
                 ...
                 $this->chart[ 'chart_transition' ] = array ( 'type'=>"slide_down", 'delay'=>0, 'duration'=>0.25, 'order'=>"category" );
                 $this->chart[ 'chart_type' ] = "parallel 3d column";
